...
const INITIAL_SPOTS: Spot[] = [
    ...
    },
    {
        ...
        "description": "【対象作品】\n≒JOY『夏はジュエリー』（YouTube ID: kIm4dcF6XDY）\n\n【登場場面】\nMV 0:45〜1:20\n\n【映像で確認できる特徴】\n砂浜、波打ち際、および背景に和賀江島（石積み遺構）周辺の海岸線が見える景観の中でダンスパフォーマンスや海辺の場面が映し出されます。\n\n【施設情報】\n鎌倉市東部に位置する海岸。由比ガ浜海岸の東側に隣接しています。\n\n【巡礼時の注意事項】\n海水浴シーズンのルールや天候・高波等の気象状況に十分注意してください。海岸の環境保全のためゴミは必ず持ち帰ってください。",
        "coordinateAccuracy": "exact",
        "workKey": "work-kIm4dcF6XDY",
        "operatorName": "鎌倉市"
    },
    {
        ...
        "description": "【対象作品】\n≒JOY『わたし注意報』（YouTube ID: RUEnyZLCtW4）\n\n【登場場面】\nMV 0:10〜1:05\n\n【映像で確認できる特徴】\n黄色・青・赤の手すりが設置された屋内滑走リンクフロア、照明演出、壁面サインを背景にしたダンス場面が映し出されます。\n\n【施設情報】\n東京ドームシティ内（黄色いビル4F）にある屋内ローラースケートリンクです。\n\n【巡礼時の注意事項】\n営業状況、利用ルール、撮影規制等は変更される場合があるため、訪問前に必ず東京ドームシティ公式WEBサイトで最新情報をご確認ください。",
        "coordinateAccuracy": "exact",
    ...
    },
    {
        ...
        "description": "【対象作品】\n≒JOY『サマーツインテール』（YouTube ID: wO2z79qqB1Y）\n\n【登場場面】\nMV 2:18〜2:25\n\n【映像で確認できる特徴】\n番場商店街沿いにある精肉店の店頭、赤いひさし、ガラスケース前で商品を受け取る場面が映し出されます。\n\n【施設情報】\n秩父市番場町にある精肉・惣菜販売店舗です。\n\n【巡礼時の注意事項】\n商品を購入せずに撮影目的のみで店頭を塞ぐ行為はお控えください。商店街の通行や一般利用者の買い物の妨げとならないようご注意ください。",
        "coordinateAccuracy": "exact",
        "workKey": "work-wO2z79qqB1Y",
    ...
    },
    {
        ...
        "description": "【対象作品】\n≒JOY『サマーツインテール』（YouTube ID: wO2z79qqB1Y）\n\n【登場場面】\nMV 1:15〜1:28\n\n【映像で確認できる特徴】\n「武州中川駅」と掲示された木造駅舎の外観、木造改札口、ホーム上の木造待合所およびホーム風景が映し出されます。\n\n【施設情報】\n秩父鉄道秩父線の駅。木造建築の駅舎と島式ホームを備える構造です。\n\n【巡礼時の注意事項】\n駅ホーム、改札口周辺、線路付近で撮影のために立ち止まらないでください。一般の列車利用者を最優先し、安全に配慮して見学してください。",
        "coordinateAccuracy": "exact",
        "workKey": "work-wO2z79qqB1Y",
    ...
    },
    {
        ...
        "description": "【対象作品】\n≒JOY『サマーツインテール』（YouTube ID: wO2z79qqB1Y）\n\n【登場場面】\nMV 1:42〜1:48\n\n【映像で確認できる特徴】\n境内にある朱色の八角堂、龍神木と呼ばれる大欅の樹木前、および「八大龍王宮」と表記された社号標周辺の境内風景が映し出されます。\n\n【施設情報】\n秩父市中町に位置する神社（八大龍王宮）。伊邪那岐大神・伊邪那美大神らを祀る歴史ある神社です。\n\n【巡礼時の注意事項】\n参拝者や神社神事・祭事の妨げにならないよう静かにご参拝ください。写真撮影時は他の参拝者のプライバシーへ配慮してください。",
    ...
    },
    {
        ...
        "description": "【対象作品】\n≒JOY『サマーツインテール』（YouTube ID: wO2z79qqB1Y）\n\n【登場場面】\nMV 2:05〜2:15\n\n【映像で確認できる特徴】\n「パリー」の看板が掲げられた石造り風の外観建物、および店舗前の屋外テーブル席での食事場面が映し出されます。\n\n【施設情報】\n昭和初期に建てられた登録有形文化財の建築物を使用している食堂です。\n\n【巡礼時の注意事項】\n注文を行わず撮影目的のみで店舗前に居座る行為はお控えください。店舗営業や他のお客様の通行の妨げにならないよう配慮してください。",
        "coordinateAccuracy": "exact",
        "workKey": "work-wO2z79qqB1Y",
        "operatorName": "パリー食堂"
    },
