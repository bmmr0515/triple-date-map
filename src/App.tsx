...
export const APP_NOTICES: Notice[] = [
  {
    id: 'notice-20260910-latest-mvs',
    date: '2026/09/10',
    title: '🎬 【作品マスター更新】＝LOVEの最新MV 3作品（『夢の続き』『恋、はじめました。』『夏名残サマーチューン』）の楽曲・動画情報を一元反映しました！',
    content: '【作品マスター更新・公式MV情報反映のお知らせ】\n＝LOVEの最新MV 3作品について、公式動画マスター（videoMaster）の登録および各聖地スポットへの情報一元反映を更新完了いたしました！\n\n■ 対象作品・公式MV\n・『夢の続き』（2026/08/25公開 MV）\n・『恋、はじめました。』（2026/08/24公開 MV）\n・『夏名残サマーチューン』（2026/08/24公開 MV）\n\n各聖地スポットの詳細ページおよびマップ右側パネルの両方にて、公式YouTube動画を快適にお楽しみいただけます。ぜひ聖地巡礼の際にお役立てください！',
    type: 'update'
  },
  {
  ...
  },
  {
    ...
    date: '2026/07/11',
    title: '🍔 【新スポット】YouTube企画「イコラブハンバーガー部」の聖地店舗（六本木・表参道・横浜の計4箇所）を追加！',
    content: '【新規聖地追加のお知らせ】\n＝LOVEの公式YouTubeチャンネルにて人気の企画「イコラブハンバーガー部」でメンバーが訪れたハンバーガーショップの聖地データを追加しました！\n\n髙松瞳さんと瀧脇笙古さんが紹介した名店で、美味しいハンバーガーを味わってみてください！\n\n■ 追加スポット\n① オービカ モッツァレラバー 六本木ヒルズ店\n（O\' バーガー、タルトゥーフォバーガー）\n② 37 ステーキハウス & バー\n（21日間熟成ブラックアンガスビーフバーガーなど）\n③ いしがまや GOKU BURGER\n（ダブル神戸牛チーズバーガーなど）\n④ BALLPARK BURGER &9\n（コラボバーガー ※現在は提供終了しています）\n\n※紹介メニューは現在提供されていない可能性があります。\n各スポットの詳細ページからYouTubeのロケ映像もあわせてお楽しみいただけます。マナーを守って美味しく楽しい聖地巡礼をお楽しみください！',
    type: 'update'
  },
  {
    id: 'notice-20260704-pokepark-yomiuri',
    date: '2026/07/04',
    title: '🌟 【新スポット】よみうりランド「ポケパークカントー」の特別ステージを追加！',
    content: '【新規聖地追加のお知らせ】\n2026年7月4日放送の『THE MUSIC DAY』にて、＝LOVEが「とくべチュ、して」「ラブソングに襲われる」の特別パフォーマンスを披露した特別なステージ「ポケパークカントー（よみうりランド）」を聖地として追加しました！\n\n詳細ページではパフォーマンス時のX（Twitter）公式ポストも埋め込み表示しています。\n\nぜひチェックインして、限定称号「とくべチュ、した者」を獲得してください！',
    type: 'update'
  },
  {
              ...
              <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
                {!selectedSpot ? (
                  ...
                  <div className="info-scroll-area">
                    ...
                    {/* ⚠️ おおよその位置警告 */}
                    {selectedSpot.coordinateAccuracy === 'approximate' && (
                      <div className="animate-fade-in-up" style={{
